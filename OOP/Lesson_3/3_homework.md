...
```
	1.	Ստեղծել Animal class որը կունենա
		...
		1.3	Ունենալ method որը կտպի 'vazum em {runing_speed} aragutyamb':
		
	2.	Ստեղծել Cat class որը կլինի Animal-ի child
	...
	4.	Ձեր ստեղծած class-ների համար գրեք __str__ method:
	
	5.	Research-ի function-ը և attribute-ները կիրառեք ձեր ստեղծած class-ների վրա:
```
