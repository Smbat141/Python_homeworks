...
```
	1.	Ինչով են տարբերվում __delete__ և __del__ method-ները:
	
	2.	Նախորդ տնայինը անել Descriptor-ի օգնությամբ:
	
		2.1	Գրել FileError Exception (default error message-ով):
...
### Research
```
	1.	garbage collector (թեթեվ պատկերացում կազմել)
```
